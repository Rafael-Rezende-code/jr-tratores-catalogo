/*
  ...
  2. Security
    ...
    - Add policy for public read access to images of available tractors
  ...
  4. Constraints
    - Foreign key to tractors table with cascade delete
    - Check constraint to ensure order is non-negative
*/
